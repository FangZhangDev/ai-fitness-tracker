...
<div align="center">
  <img src="../docs/screenshots/watch-record.png" alt="记录页真机截图" width="320">
  <p><em>记录页（Watch 3 真机）：转表冠调当前字段，点标签切换重量 / 组数 / 次数 / RIR</em></p>
</div>
...
屏幕：每次交互（进页面 / 转表冠 / 点列表）把屏幕续 **30 秒**，到点交还系统息屏。
整个前台强制常亮太费电，而系统默认那几秒又不够看完一组——`common/screen.js`
里的 `HOLD_MS` 是唯一的调节点。
